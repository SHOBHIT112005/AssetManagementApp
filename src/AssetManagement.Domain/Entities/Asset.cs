...
public class Asset
{
    ...
    [Range(typeof(DateOnly), "2010-01-01", "2040-12-31", ErrorMessage = "Purchase date must be between 2010 and 2040.")]
    public DateOnly PurchaseDate { get; set; }
    [Required(ErrorMessage = "Please enter the warranty expiry date.")]
    [Range(typeof(DateOnly), "2010-01-01", "2040-12-31", ErrorMessage = "Warranty expiry date must be between 2010 and 2040.")]
